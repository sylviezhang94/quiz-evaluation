...
REVIEW_S2 = [
    ...
    LevelRule(Level.A2, QuestionType.REVIEW_S2, LearningMode.ENGLISH,
        fill_mode="选词", candidate_count=4, min_words=5, max_words=12,
        sentence_type="短句", option_language="英文",
        description="A2英语学英语：点击选词填入，4个候选英文单词，短句5-12词"),
    LevelRule(Level.A2, QuestionType.REVIEW_S2, LearningMode.NATIVE,
        fill_mode="选词", candidate_count=4, min_words=5, max_words=12,
        sentence_type="短句", option_language="英文",
        description="A2母语学英语：点击选词填入，4个候选英文单词，短句5-12词"),
    # B1
    LevelRule(Level.B1, QuestionType.REVIEW_S2, LearningMode.ENGLISH,
        fill_mode="选词", candidate_count=4, min_words=8, max_words=14,
        sentence_type="简单句", option_language="英文",
        description="B1英语学英语：点击选词填入，4个候选词，简单句8-14词"),
    LevelRule(Level.B1, QuestionType.REVIEW_S2, LearningMode.NATIVE,
        fill_mode="选词", candidate_count=4, min_words=8, max_words=14,
        sentence_type="简单句", option_language="英文",
        description="B1母语学英语：点击选词填入，4个候选词，简单句8-14词"),
    # B2
    LevelRule(Level.B2, QuestionType.REVIEW_S2, LearningMode.ENGLISH,
        fill_mode="拼写", min_words=6, max_words=14, sentence_type="日常复合句",
        description="B2英语学英语：拼写填空，日常复合句6-14词"),
    LevelRule(Level.B2, QuestionType.DRAG_SORT, LearningMode.NATIVE,
        fill_mode="拖拽排序", min_words=6, max_words=14, sentence_type="日常复合句",
        has_interference=True,
        description="B2母语学英语：中译英拖拽排序，日常复合句6-14词，有干扰项"),
    # C1
    LevelRule(Level.C1, QuestionType.REVIEW_S2, LearningMode.ENGLISH,
        fill_mode="拼写", min_words=10, max_words=18, sentence_type="复杂句",
        description="C1英语学英语：拼写填空，复杂句10-18词"),
    LevelRule(Level.C1, QuestionType.DRAG_SORT, LearningMode.NATIVE,
        fill_mode="拖拽排序", min_words=10, max_words=18, sentence_type="复杂句",
        has_interference=True,
        description="C1母语学英语：中译英拖拽排序，复杂句10-18词，有干扰项"),
    # C2
    LevelRule(Level.C2, QuestionType.REVIEW_S2, LearningMode.ENGLISH,
        fill_mode="拼写", min_words=12, max_words=25, sentence_type="复杂结构句",
        description="C2英语学英语：拼写填空，复杂结构句12-25词"),
    LevelRule(Level.C2, QuestionType.DRAG_SORT, LearningMode.NATIVE,
        fill_mode="拖拽排序", min_words=12, max_words=25, sentence_type="复杂结构句",
        has_interference=True,
        description="C2母语学英语：中译英拖拽排序，复杂结构句12-25词，有干扰项"),
]
